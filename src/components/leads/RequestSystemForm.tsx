...
const RequestSystemForm = () => {
  ...
  const fallbackMailto = useMemo(
    () =>
      `mailto:nitiance@gmail.com?subject=${encodeURIComponent("System Request")}&body=${encodeURIComponent(summary)}`,
    [summary],
  );
  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-5 md:gap-6">
        <div>
          <label htmlFor="rs-full-name" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Full name
          </label>
          <input
            id="rs-full-name"
        ...
        <div>
          <label htmlFor="rs-business-name" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Business name
          </label>
          <input
            id="rs-business-name"
        ...
        <div>
          <label htmlFor="rs-business-email" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Business email
          </label>
          <input
            id="rs-business-email"
            type="email"
            required
        ...
        <div>
          <label htmlFor="rs-phone" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
        ...
        <div>
          <label htmlFor="rs-industry" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Industry
          </label>
          <select
            id="rs-industry"
        ...
        <div>
          <label htmlFor="rs-mode" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Mode
          </label>
          <select
            id="rs-mode"
        ...
        <div>
          <label htmlFor="rs-devices-count" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
        ...
        <div>
          <label htmlFor="rs-branches-count" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Branches count
          </label>
          <input
            id="rs-branches-count"
            type="number"
            required
            min={1}
      ...
      <div className="grid md:grid-cols-2 gap-5 md:gap-6 mt-6">
        <div>
          <label htmlFor="rs-timeline" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
            Timeline
          </label>
          <select
            id="rs-timeline"
        ...
        <div>
          <label htmlFor="rs-budget" className="block text-xs uppercase tracking-wide text-[#2B3440]/70 mb-2">
      ...
      <div className="hidden" aria-hidden="true">
        <label htmlFor="rs-company-website">Company website</label>
        <input
          id="rs-company-website"
          tabIndex={-1}
          autoComplete="off"
          value={honeypot}
