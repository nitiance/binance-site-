    ...
    return (
      <section className="bg-[#0B0F14] text-[#F7F3EE] min-h-[70vh]">
        <div className="max-w-[1200px] mx-auto px-6 py-24">
          <p className="text-xs uppercase tracking-wide text-[#F7F3EE]/50 mb-4">Modules</p>
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">Module not found</h1>
          <p className="mt-4 text-sm text-[#F7F3EE]/70 max-w-md">
            This page is unavailable. Use the modules directory to open a valid module page.
          </p>
          <Link
            to="/systems"
    ...
    <div>
      <section className="bg-[#0B0F14] text-[#F7F3EE] border-b border-white/10">
        <div className="max-w-[1200px] mx-auto px-6 py-20 md:py-24">
          <ScrollReveal>
            <p className="text-xs uppercase tracking-wide text-[#F7F3EE]/50 mb-4">Module</p>
            ...
            <p className="mt-2 text-xs text-[#F7F3EE]/55">Part of the BinanceXI business system.</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <div className="mt-8 flex flex-wrap gap-5 text-sm">
              ...
              >
                ...
                Request the system suite
              </Link>
              <a
                href="https://wa.me/263782750867?text=Hi%20Nitiance%2C%20I%20want%20to%20discuss%20the%20business%20system%20on%20your%20site."
                target="_blank"
      ...
      <section className="bg-[#F7F3EE] border-t border-[#D8CEC2]">
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20">
          <ScrollReveal>
            <p className="text-xs uppercase tracking-wide text-[#2B3440]/60 mb-5">Other modules</p>
          </ScrollReveal>
